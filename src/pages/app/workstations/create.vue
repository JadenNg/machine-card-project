<template lang="vi">
<div>
    <page-header :title="`Create new workstation`" :items="breadcrumbs" />
    <div v-if="!loading">
        <b-row>
            <b-col class="col-lg-8">
                <b-card>
                    <b-form-group>
                        <label>Name workstation<span class="red"> *</span></label>
...
export default {
    ...
    methods: {
        ...
        async create() {
            ...
            await Swal.queue([{
                title: 'Create this new workstation?',
                ...
                preConfirm: async () => {
                    ...
                    let response = await httpClient.post(`workstation/create`, payload)
