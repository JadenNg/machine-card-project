...
<div class="container" @dragover.prevent="dragOver" @dragleave.prevent="dragLeave" @drop.prevent="drop($event)">
    ...
    <div v-show="Imgs.length === 0" class="beforeUpload">
        <input type="file" style="z-index: 1" :accept="accept ? accept : `*/*`" ref="uploadInput" @change="previewImgs" multiple />
                ...
                <g id="_Group_" data-name="&lt;Group&gt;">
                    <g id="_Group_2" data-name="&lt;Group&gt;">
                        <g id="_Group_3" data-name="&lt;Group&gt;">
                            <circle id="_Path_" data-name="&lt;Path&gt;" cx="18.5" cy="16.5" r="5" style="
                    fill: none;
                    stroke: #303c42;
                  ...
                  " />
                        ...
                        <polyline id="_Path_2" data-name="&lt;Path&gt;" points="16.5 15.5 18.5 13.5 20.5 15.5" style="
                  fill: none;
                  stroke: #303c42;
                  stroke-linecap: round;
                  stroke-linejoin: round;
                " />
                        <line id="_Path_3" data-name="&lt;Path&gt;" x1="18.5" y1="13.5" x2="18.5" y2="19.5" style="
                  fill: none;
                  stroke: #303c42;
                  stroke-linecap: round;
                  stroke-linejoin: round;
                ...
                if (status === true) {
                    if (
                        ...
                        for (let i = 0; i < e.dataTransfer.files.length; i++) {
                            this.files.push(this.readAsBinaryString(e.dataTransfer.files[i]));
                        }
                        this.previewImgs();
                    }
                } else {
